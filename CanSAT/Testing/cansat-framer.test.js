...
const { CansatFrameParser } = require('../Firmware/Ground_Station/cansat-framer');
const { PACKET_SYNC, PACKET_V3_LENGTH_BYTES, crc16Ccitt } = require('../Firmware/Ground_Station/cansat-hardware');
