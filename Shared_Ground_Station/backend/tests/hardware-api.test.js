...
const { deriveSensorHealth, packetIdLimitForSource } = require('../../../CanSAT/Firmware/Ground_Station/cansat-hardware');
...
test('Mach-X Rideshare dashboard renders successful SD uploads', () => {
  const dashboard = fs.readFileSync(path.resolve(__dirname, '../../../CanSAT/Dashboard/mach-x.html'), 'utf8');
...
test('CanSat firmware uses RFM69 433 MHz and flight indicator pins', () => {
  const firmware = fs.readFileSync(path.resolve(__dirname, '../../../CanSAT/Firmware/Flight_Computer/src/main.cpp'), 'utf8');
  const telemetry = fs.readFileSync(path.resolve(__dirname, '../../../CanSAT/Firmware/Flight_Computer/include/telemetry.h'), 'utf8');
...
test('CanSat ground receiver accepts v2 and v3 frames indefinitely', () => {
  const firmware = fs.readFileSync(path.resolve(__dirname, '../../../CanSAT/Firmware/Ground_Station/src/main.cpp'), 'utf8');
...
test('Mach-X Rideshare firmware uses MXR3 live telemetry prefix', () => {
  const firmware = fs.readFileSync(path.resolve(__dirname, '../../../Rideshare_Payload/Firmware/Flight_Computer/src/main.cpp'), 'utf8');
  const platformio = fs.readFileSync(path.resolve(__dirname, '../../../Rideshare_Payload/Firmware/Flight_Computer/platformio.ini'), 'utf8');
...
test('Mach-X Rideshare firmware makes LoRa airtime limiting explicit', () => {
  const firmware = fs.readFileSync(path.resolve(__dirname, '../../../Rideshare_Payload/Firmware/Flight_Computer/src/main.cpp'), 'utf8');
  const guide = fs.readFileSync(path.resolve(__dirname, '../../../Rideshare_Payload/Documentation/rideshare_payload_testing_guide.md'), 'utf8');
...
test('Mach-X Rideshare ground receiver matches flight LoRa settings and forwards MXR telemetry', () => {
  const firmware = fs.readFileSync(path.resolve(__dirname, '../../../Rideshare_Payload/Firmware/Ground_Station/src/main.cpp'), 'utf8');
  const platformio = fs.readFileSync(path.resolve(__dirname, '../../../Rideshare_Payload/Firmware/Ground_Station/platformio.ini'), 'utf8');
...
test('ESP32-CAM recording firmware latches local SD recording faults', () => {
  const firmware = fs.readFileSync(path.resolve(__dirname, '../../../Rideshare_Payload/Firmware/Camera_Module/src/main.cpp'), 'utf8');
